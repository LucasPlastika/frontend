...
function root({
  ...
  return {
    ...
    jsonLd: {
      ...
      sameAs: [
        'https://instagram.com/yasy',
        'https://facebook.com/yasy',
        'https://tiktok.com/@yasy',
      ],
      url,
      potentialAction: {
        '@type': 'SearchAction',
...
function home({url}: {url: Request['url']}): SeoConfig {
  return {
    title: 'Home',
    titleTemplate: '%s | Yasy',
    description: 'Pipoca gourmet zero açúcar. Prazer sem culpa, do jeito YASY.',
    url,
    robots: {
      noIndex: false,
      noFollow: false,
...
function listCollections({
  ...
  return {
    title: 'Coleções',
    titleTemplate: '%s | Yasy',
    description: 'Conheça todas as coleções YASY',
    url,
...
function policies({
  ...
  return {
    title: 'Políticas',
    titleTemplate: '%s | Yasy',
    description: 'Políticas da loja YASY',
    jsonLd: [
      {
        '@context': 'https://schema.org',
        '@type': 'BreadcrumbList',
