  ...
  return (
    <div className="flex flex-col mt-2 gap-2">
      ...
      {layout === 'drawer' && (
        <Link
          to="/cart"
          className="text-center text-xs font-medium text-gray-600 hover:text-black underline"
        >
  ...
  return (
    <div ref={scrollRef} className={container[layout]} hidden={hidden}>
      <section className="grid gap-6">
        <Text format>
          Seu carrinho está vazio. Que tal dar uma olhada nos nossos produtos?
        </Text>
        <div>
          <Button onClick={onClose} to="/collections/all">
            Ver Produtos
          </Button>
        </div>
      </section>
