    ...
    <div className="bg-secondary min-h-screen">
      <div className="container mx-auto px-4 lg:px-0 py-12 lg:py-20">
        <nav className="mb-6 flex items-center gap-2 text-sm font-bold uppercase text-contrast">
          ...
          <span className="font-serif text-contrast">Política de Privacidade</span>
        </nav>

        <h1 className="text-6xl lg:text-8xl font-sans-2 uppercase text-contrast">
          Política de <span className="font-sans-2 text-primary">Privacidade</span>
        </h1>
        ...
        <div className="space-y-8 text-contrast/90 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:privacidade@yasy.com.br" className="font-bold text-contrast underline hover:text-contrast/70 transition-colors">
